...
public interface TargetingCriteriaForm extends TwitterForm {
    ...
    /**
     * A comma-separated string of “unordered” keywords to target. These are typically used to match words appearing in any order
    ...
    /**
     * A comma-separated string of “phrase” keywords to target. These are typically used to match phrases appearing within search queries for
    ...
    /**
     * A comma-separated string of “negative exact match” keywords to target. These are typically used to restrict a very specific search query for
     * PROMOTED_TWEETS_IN_SEARCH. A maximum of 1,000 keywords may be attached to a line item.
     *
     * Example Values: %23freebandnames, http%3A%2F%2Fen.wikipedia.org%2Fwiki%2FIn_Watermelon_Sugar
     *
    ...
    /**
     * A comma-separated string of “negative unordered” keywords to target. These are typically used to restrict matching keywords appearing in any
    ...
    /**
     * A comma-separated string of “negative phrase” keywords to target. These are typically used to restrict specific phrases from matching within
    ...
    /**
     * A comma-separated string of gender identifiers to scope targeting to on this line item. Use “1” to limit to males, or “2”, to limit to females.
